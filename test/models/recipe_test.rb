...
class RecipeTest < ActiveSupport::TestCase
    ...
    def setup
        ...
        @recipe = @chef.recipes.create( name: "chicken parm", summary: "This is the best chicken parm recipe", description: "heat oli, add 2 onions, add tomato source, add chicken, cook 20 minutes.") 
    end
